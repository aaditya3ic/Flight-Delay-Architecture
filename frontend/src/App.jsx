...
// /**
//  * "Flight Delay Intelligence" — hero interpretation
//  * adapted from mesh3d.gallery aesthetic for ML Architecture
//  */
...
//       const n = 0.14 * Math.sin(v.x * 2.1) * Math.cos(v.y * 1.7);
...
//     const dotMat = new THREE.PointsMaterial({ color: 0xf3f1eb, size: 0.022, transparent: true, opacity: 0.5 });
...
//       mesh.rotation.x = Math.sin(t * 0.06) * 0.15;
...
/**
 * "Flight Delay Intelligence" — Globe Integration
 * adapted for ML Architecture
 */
